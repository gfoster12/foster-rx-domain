/*
 * noble-ed25519 — vendored for the Foster Rx verify page (Phase 2.8 Workstream 2).
 *
 *   Package:      @noble/ed25519
 *   Version:      2.3.0
 *   Upstream:     https://www.npmjs.com/package/@noble/ed25519/v/2.3.0
 *   Source repo:  https://github.com/paulmillr/noble-ed25519
 *   Vendored on:  2026-06-15  (via: npm pack @noble/ed25519@2.3.0)
 *   License:      MIT (c) 2019 Paul Miller (paulmillr.com)
 *
 * PROVENANCE / AUDIT
 *   The content BELOW this header block is the verbatim upstream
 *   package/index.js (ESM, dependency-free). SHA-256 of that upstream
 *   index.js (header excluded):
 *       70cebecaaa6a126ced702198706c49d03f2d6f70317342b75e50e8d2d4951fe5
 *   To audit: delete this header block and run `sha256sum` on the remainder.
 *
 * INTEGRITY
 *   This file is loaded with a Subresource Integrity (SHA-384) pin in
 *   /verify/index.html (via <link rel="modulepreload" integrity="...">).
 *   It is self-hosted, NOT loaded from a CDN: a cryptographic verifier must
 *   not be swappable by any third party. Cosmetic libraries elsewhere on the
 *   site may use a CDN; this one may not.
 */
